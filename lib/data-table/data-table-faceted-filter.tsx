...
import { cn, ViewableOptions } from "@/utils";
...
import { ListFilter, Check, LucideProps } from "lucide-react";

interface DataTableFacetedFilterProps<TData, TValue> {
  column?: Column<TData, TValue>;
  title?: string;
  options: ViewableOptions<TValue, React.ComponentType<LucideProps>>[];
}
